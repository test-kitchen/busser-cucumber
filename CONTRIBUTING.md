# Contributing to busser-cucumber
...
```bash
git clone https://github.com/test-kitchen/busser-cucumber.git
cd busser-cucumber
bundle install
```
...
Maintainers do not bump `lib/busser/cucumber/version.rb` or edit
